...
const float DURATION = 0.25; // in seconds (kitty cursor_trail_decay 0.1-0.4)
const float MAX_TRAIL_LENGTH = 0.35;
const float THRESHOLD_MIN_DISTANCE = 1.0; // min distance to show trail (units of cursor width) ~ kitty threshold 1 cell
